...
public class TestListener extends BaseTest implements ITestListener {
    ...
    public static Logger logger = Logger.getLogger(Listener.TestListener.class);
...
//            byte[] b = Files.readAllBytes(Paths.get(filePath));
    ...
    public byte[] saveScreenshotPNG (WebDriver driver) {
        ...
        Allure.getLifecycle().addAttachment("failed  screenshot", "image/png", "png", img);
        return img;
    }
    @Attachment(value = "pass screenshot", type = "image/png")
    public byte[] saveScreenshotPNG1 (WebDriver driver) {
        byte[] img = ((TakesScreenshot)driver).getScreenshotAs(OutputType.BYTES);
        Allure.getLifecycle().addAttachment("pass screenshot", "image/png", "png", img);
        return img;
    }
